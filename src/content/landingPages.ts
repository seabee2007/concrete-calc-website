...
export const constructionProjectManagementPage: Omit<TopicLandingPageProps, never> = {
  ...
  title: 'Construction Project Management Software for Contractors | Project OS',
  description:
  ...
  intro:
    'Project OS gives contractors one workspace for estimates, proposals, schedules, change orders, daily reports, RFIs, and client visibility — without juggling spreadsheets, email threads, and disconnected apps.',
  sections: [
    {
      heading: 'One workspace for the full project lifecycle',
      paragraphs: [
        'Most contractors lose time switching between estimating spreadsheets, scheduling tools, shared drives, and text messages. Project OS connects preconstruction, field execution, and client communication in a single project record so your team always works from the same numbers and timeline.',
    ...
    },
    {
      ...
      paragraphs: [
        'General contractors, subcontractors, estimators, and project managers need different views of the same job. Project OS supports activity-based estimating, logic networks, Gantt schedules, field portals, and document exports without forcing every role into a generic task list.',
    ...
    },
    {
      ...
      paragraphs: [
        'You do not need a separate app for estimates, another for schedules, and another for change orders. Project OS keeps project financials, production assumptions, and schedule logic in one place so revisions are faster and less error-prone.',
    ...
    },
    {
      ...
      paragraphs: [
        ...
        'Whether you manage one active job or a portfolio of projects, Project OS helps your team stay aligned on scope, cost, schedule, and communication.',
      ],
    },
    {
      heading: 'Start with a platform designed for construction',
      paragraphs: [
        'Project OS is cloud-based construction project management software — no installs, no per-device sync headaches. Choose a plan, set up your first project, and see how much cleaner your estimating, scheduling, and field workflow can be.',
      ],
    },
  ],
...
export const constructionEstimatingPage: Omit<TopicLandingPageProps, never> = {
  ...
  title: 'Construction Estimating Software for Contractors | Project OS',
  description:
    'Build detailed construction estimates with activities, labor rates, markup, and export-ready proposals in Project OS estimating software for contractors.',
  ...
  sections: [
    {
      ...
      paragraphs: [
        'Flat spreadsheet formulas break down when projects grow in scope and complexity. Project OS supports construction activities, production rates, crew assumptions, and cost rollups so estimators can build bids that reflect how work is actually performed.',
    ...
    },
    {
      ...
      paragraphs: [
        ...
        'Project OS helps estimators compare alternatives, document assumptions, and produce exports that are easier to review before bid day.',
      ],
    },
    {
    ...
    },
    {
      ...
      paragraphs: [
        'Stop rebuilding bids from scratch every time scope shifts. Project OS gives contractors a dedicated estimating workspace inside a broader construction project management platform.',
      ],
    },
  ],
  relatedLinks: related.core,
...
export const constructionSchedulingPage: Omit<TopicLandingPageProps, never> = {
  ...
  title: 'Construction Scheduling Software with CPM & Gantt | Project OS',
  description:
    'Plan construction schedules with logic networks, CPM, Level III Gantt charts, and crew demand views in Project OS scheduling software.',
  ...
  sections: [
    {
      ...
      paragraphs: [
        'Construction schedules fail when dependencies are vague or buried in spreadsheet rows. Project OS includes logic network tools so planners can define predecessor and successor relationships before running CPM calculations.',
    ...
    },
    {
      ...
      paragraphs: [
        'Schedules are not just dates — they imply crew loading, equipment usage, and trade stacking. Project OS helps teams review crew demand and resource assumptions alongside the schedule so conflicts surface earlier.',
    ...
    },
    {
      ...
      paragraphs: [
        'Project OS combines scheduling with estimating, proposals, and field records so your team plans from one source of truth.',
      ],
    },
  ],
  relatedLinks: related.core,
...
export const contractorProposalPage: Omit<TopicLandingPageProps, never> = {
  ...
  title: 'Contractor Proposal Software | Project OS',
  description:
    'Create polished contractor proposals from estimates with branding, scope clarity, and PDF exports in Project OS.',
  ...
  sections: [
    {
      ...
      paragraphs: [
        'Manual proposal assembly invites errors when pricing, exclusions, and scope notes drift away from the underlying bid. Project OS generates proposals from your estimate so numbers and scope stay aligned.',
    ...
    },
    {
      ...
      paragraphs: [
        'Project OS helps contractors present accurate, polished bids without maintaining a separate proposal template stack.',
      ],
    },
  ],
  relatedLinks: related.core,
...
export const changeOrderManagementPage: Omit<TopicLandingPageProps, never> = {
  ...
  title: 'Change Order Management Software for Contractors | Project OS',
  description:
    'Track construction change orders with scope, cost, schedule impact, and approval history in Project OS.',
  ...
  sections: [
    {
      ...
      paragraphs: [
        'Unrecorded changes erode margin fast. Project OS gives teams a structured place to log change order requests with scope description, cost impact, supporting notes, and approval status.',
    ...
    },
    {
      ...
      paragraphs: [
        'When field teams identify a change, office teams should not rebuild context from memory. Project OS connects change orders to project estimates, daily reports, RFIs, and schedule data.',
...
export const constructionClientPortalPage: Omit<TopicLandingPageProps, never> = {
  ...
  title: 'Construction Client Portal for Approvals & Visibility | Project OS',
  description:
    'Give clients controlled visibility into proposals, approvals, schedule updates, and project records with a Project OS client portal.',
  ...
  sections: [
    {
      ...
      paragraphs: [
        'Owners and clients need updates, but they should not see every internal cost assumption. Project OS supports controlled sharing so you decide what clients can view and approve.',
    ...
    },
    {
      ...
      paragraphs: [
        'Project OS helps contractors present a professional client experience while protecting internal project data.',
      ],
    },
  ],
  relatedLinks: related.core,
...
export const constructionDailyReportsPage: Omit<TopicLandingPageProps, never> = {
  ...
  title: 'Construction Daily Reports & Field Updates | Project OS',
  description:
    'Capture construction daily reports, field notes, labor, equipment, and jobsite activity in Project OS.',
  ...
  sections: [
    {
      ...
      paragraphs: [
        'Paper logs and text messages disappear. Project OS gives field teams a structured way to submit daily reports with labor, equipment, weather notes, delays, and work completed.',
    ...
    },
    {
      ...
      paragraphs: [
        'Supers, foremen, and field staff need simple workflows. Office teams need reliable records. Project OS connects both sides without forcing field users into heavy ERP screens.',
...
export const rfiFarQcPage: Omit<TopicLandingPageProps, never> = {
  ...
  title: 'RFI, FAR, and QC Software for Construction | Project OS',
  description:
    'Manage RFIs, field action requests, and QC records in one construction project workspace with Project OS.',
  ...
  sections: [
    {
      ...
      paragraphs: [
        'Requests for information often get lost when they live only in email threads. Project OS helps teams log RFIs with status, responsibility, and project context so answers do not delay field work.',
    ...
    },
    {
      ...
      paragraphs: [
        'Quality control is easier to defend when inspections, notes, and corrective actions are stored in the project record. Project OS helps teams maintain QC history without separate binders or ad hoc folders.',
    ...
    },
    {
      ...
      paragraphs: [
        'Project OS combines RFIs, FARs, QC, and broader project management in one contractor workspace.',
      ],
    },
  ],
  relatedLinks: related.core,
