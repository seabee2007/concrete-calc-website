...
const MARKETABLE_FEATURE_LABELS: Record<string, string> = {
  ...
  arden_calc_in_estimator: 'Construction Calc inside the estimator',
  bill_of_materials: 'Procurement Bill of Materials and exports',
  bom_ai_pricing: 'AI-assisted material price suggestions',
